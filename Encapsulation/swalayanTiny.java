...
public class swalayanTiny {
        ...
        public swalayanTiny(double saldo,String pin){
           this.saldo=saldo;
           this.pin=pin;
        }
        ...
        public void topUp(double TopUp, String pin){
           if(pin.equals(getPin())){
                 if(TopUp>=10000){
                    ...
                    System.out.println("Mohon maaf, saldo minimal untuk top-up masih kurang silahkan ulang kembali.");
                 ...
                 if(salahAutentikasi == batasSalahAutentikasi){
                    ...
                    System.out.println("Pin yang anda masukkan salah.");
                    System.out.println("Kesalahan pin : " + salahAutentikasi);
                 }
                }
              }
